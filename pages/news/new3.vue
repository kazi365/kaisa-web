...
<template>
    <article>
        ...
        <div class="container">
            ...
            <div>
                <p>2023/10/09 08:34</p>
                <hr>

            </div>
            <div class="content">
                <p class="paragraph">
                    亚运聚欢潮，璀璨共此时。第19届亚洲运动会8日晚在杭州圆满闭幕。国务院总理李强出席闭幕式。
                </p>
                <p class="paragraph">
                ...
                <p class="paragraph">
                    亚奥理事会代理主席辛格在致辞中说，本届亚运会精彩绝伦、令人难忘，取得了空前成功。感谢中国政府、中国奥委会、杭州市民与杭州亚组委的精心筹备。辛格宣布杭州第19届亚运会闭幕，并发出邀请，三年后相聚爱知·名古屋第二十届亚运会。
                </p>
                <p class="paragraph">
